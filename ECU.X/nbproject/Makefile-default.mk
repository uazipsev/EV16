...
${OBJECTDIR}/SScomms.o: SScomms.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  SScomms.c  -o ${OBJECTDIR}/SScomms.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/SScomms.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -no-legacy-libc  -mlarge-data -O0 -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/ThrottleBrakeControl.o: ThrottleBrakeControl.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  ThrottleBrakeControl.c  -o ${OBJECTDIR}/ThrottleBrakeControl.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/ThrottleBrakeControl.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -no-legacy-libc  -mlarge-data -O0 -msmart-io=1 -Wall -msfr-warn=off  
